...
#
# Generated by export_simulation on Mon Nov 29 10:28:05 EST 2021
#
################################################################################
...
'-reset_run' switch to the './clkGen25.sh' script.

./clkGen25.sh -reset_run
...
./clkGen25.sh -noclean_files

For more information on the script, please type './clkGen25.sh -help'.
