...
HD_PWD='C:/Xilinx/projects/lab2ece433adders/lab2ece433adders.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log adderSCCversion1.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source adderSCCversion1.tcl -notrace
