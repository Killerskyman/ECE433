...
HD_PWD='C:/Xilinx/projects/lab2ece433adders/lab2ece433adders.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log adderSCCversion1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source adderSCCversion1.tcl
