...
HD_PWD='C:/Xilinx/projects/lab1part1SCC/lab1part1SCC.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log gate3SCC.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source gate3SCC.tcl -notrace
