...
HD_PWD='C:/Xilinx/projects/lab1part1SCC/lab1part1SCC.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log gate3SCC.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source gate3SCC.tcl
