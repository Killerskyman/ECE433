...
HD_PWD='C:/Xilinx/projects/lab1part2ECE433SCC/lab1part2ECE433SCC.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log lab1part2SCC.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source lab1part2SCC.tcl -notrace
