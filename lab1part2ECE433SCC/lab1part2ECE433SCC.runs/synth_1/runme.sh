...
HD_PWD='C:/Xilinx/projects/lab1part2ECE433SCC/lab1part2ECE433SCC.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log lab1part2SCC.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source lab1part2SCC.tcl
