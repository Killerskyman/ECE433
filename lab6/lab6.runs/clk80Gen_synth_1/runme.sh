...
HD_PWD='/home/skillet/git/ECE433/lab6/lab6.runs/clk80Gen_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log clk80Gen.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source clk80Gen.tcl
