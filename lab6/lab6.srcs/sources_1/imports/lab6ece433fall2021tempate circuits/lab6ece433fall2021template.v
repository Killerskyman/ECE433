...
case(Mode)
    0: RAMaddress <= RAMaddressUpdate;
    1: RAMaddress <= AddressSend;
endcase
...
RAM64x7bitsJJS RAMUnit(reset, clk80MHz, WriteOrRead, RAMaddress, DataIn, RAMDataout);

//ROM
blk_mem_gen_0 ROMunit (.clka(clk80MHz),
...
SendChars2020Fall SendCharsUnit(Send, tx_full, reset, clk80MHz, tx_data, write_to_uart, Transmitting, AddressSend);
...
UARTmodulefall2021oneshots #(8, 20'd57600, 30'd80000000) UART (rx, tx, tx_full, , , write_to_uart, , tx_data, transmitted_bits, clk80MHz, reset);
